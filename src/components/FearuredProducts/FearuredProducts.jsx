...
import styles from './FearuredProducts.module.css';
...
export default function FearuredProducts()  {
...
<i  onClick={()=> addWishlist(product?._id)} className='fa-regular px-3 cursor-pointer  text-danger  fa-heart fa-lg'></i>
